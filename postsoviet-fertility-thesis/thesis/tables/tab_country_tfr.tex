...
\quad Kazakhstan & 1.90 & 2.61 & 2.74 & 3.01 & +1.11 & +0.27 \\
...
\addlinespace
\quad \textit{Bloc mean} & 2.67 & 2.90 & 2.91 & 3.09 & +0.43 & +0.19 \\
\addlinespace
...
\quad Latvia & 1.24 & 1.37 & 1.70 & 1.34 & +0.10 & -0.36 \\
...
\quad Central Asia $-$ rest & 1.29 & 1.27 & 1.22 & 1.65 & & \\
\bottomrule
\end{tabular}
...
\emph{Note:} Eleven of the fourteen 2023 values are WPP projections rather than retrospective
interpolated estimates; only Latvia, Lithuania and Russia are interpolated in 2023.
\end{minipage}
\end{table}