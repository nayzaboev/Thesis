...
Measurement is uneven. TFR values throughout are harmonised model-based estimates rather than raw registration counts, with additional uncertainty in the eleven of fourteen 2023 observations classified as projections rather than retrospective estimates, and the singulate mean age at marriage is assembled from three sources with different marital-status definitions and observation years spanning 2012 to 2022, with a known bias direction that runs against the pattern of interest.
