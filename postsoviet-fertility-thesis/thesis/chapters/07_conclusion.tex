...
This thesis measures that divergence, shows that the standard economic explanations do not account for the greater part of it, and marks out the boundary of what fourteen countries observed over twenty-four years can establish. What lies beyond the boundary is where the answer is: marriage, ethnicity, gender norms, expectations about the future. These are the channels in which further explanation should be sought, and they require individual-level data this design does not have.
